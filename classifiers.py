...
from capsule_network import predict_cap
import torch
...
class MesoInception4(Classifier):
    ...
    def InceptionLayer(self, a, b, c, d):
        def func(x):
            ...
            x3 = Conv2D(
                c, (3, 3), dilation_rate=2, strides=1, padding="same", activation="relu"
            )(x3)

            x4 = Conv2D(d, (1, 1), padding="same", activation="relu")(x)
            x4 = Conv2D(
                d, (3, 3), dilation_rate=3, strides=1, padding="same", activation="relu"
            )(x4)
